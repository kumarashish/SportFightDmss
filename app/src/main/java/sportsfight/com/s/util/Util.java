...
public static String[] months={"Jan","Feb ","March","April","May","June","July","Aug","Sep","Oct","Nov","Dec"};
    ...
    public static NoInternetDialog showInternetDialog(Activity act) {
        NoInternetDialog noInternetDialog = new NoInternetDialog.Builder(act).setBgGradientStart(act.getResources().getColor(R.color.tabselected)).setBgGradientCenter(act.getResources().getColor(R.color.white)) // Center color for background gradient
                .setButtonColor(act.getResources().getColor(R.color.tabselected)) // Set custom color for dialog buttons
                .setButtonTextColor(act.getResources().getColor(R.color.white))
                .setButtonIconsColor(act.getResources().getColor(R.color.white)) // Set custom color for icons of dialog buttons
    ...
    public static String getCompleteAddressString(final Activity act, final double LATITUDE, final double LONGITUDE) {
        ...
        try {
            ...
            //strAdd =list.get(0).get SubLocality() +","+list.get(0).getLocality();
